...
export function Navbar() {
  ...
  return (
    <header className="sticky inset-x-0 top-0 z-50 w-full border-b border-slate-200/70 bg-white/80 backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-950/80">
